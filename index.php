...
<html class="theme-dark">
  <head>
    ...
    <meta name="author" content="Jiray Software">
    <meta property="og:image" content="https://i.imgur.com/8v7xo6s.jpg">
    <meta name="keywords" content="Website Key Tool Free By Jiray Software">
    <meta name="description" content="Website Key Tool Free By Jiray Software">
    <title>Website Key Tool Free</title>
    <meta property="og:title" content="Website Key Tool Free">
    <meta property="og:url" content="#">
    <link rel="shortcut icon" href="https://i.imgur.com/8v7xo6s.jpg" type="image/x-icon">
    <link rel="stylesheet" href="./style/styl.css">
 <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Pattaya|Potta One|Rowdies">
    <link rel="stylesheet" href="https://unpkg.com/aplayer@1.10.1/dist/APlayer.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <script type="text/javascript" src="https://unpkg.com/aplayer@1.10.1/dist/APlayer.min.js"></script>
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2072008491385446" crossorigin="anonymous"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js"></script>
  </head>
        </style>
  <br>
<h2 style=" text-align: center; font-size: 26px;color: rgb(255, 0, 0);text-shadow: 0 0 30px rgb(255, 0, 0);">
  Jiray TV
   </h2>
</b>
<br>
<center>
<img src="https://i.imgur.com/oiqq892.png" style=“width:250px;height:250px;”>
</center>
<br>
<span style="font-family: Comic Sans MS">
<span style="font-size:24px">
          <br>
            <p style=" text-align: center; font-family: Rowdies; font-size: 16px;color: #FFFF00">
               &emsp; Cảm Ơn Các Bạn Đã Vượt Link Rút Gọn Để Lấy Key Tool Free &emsp; </p>
        <br>
<?php
    $key = $_GET['key'];
    echo "<center>";
...
?>
    ...
    <footer class="footer-container layout-block">
      <div class="social-icons">
        <a href="https://github.com/Jiray" class="soft-size--primary soft-style--box" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://twitter.com/Jiray" class="soft-size--primary soft-style--box" target="_blank" rel="noopener noreferrer">
        ...
        <a class="soft-size--primary soft-style--box" href="https://www.instagram.com/Jiray_205/" target="_blank" rel="noopener noreferrer">
      ...
      <p>All rights reserved - © 2024 <a>Jiray Software</a></p>
      <p> Vận hành bởi <a href="https://zalo.me/0978200223" target="_blank" rel="noopener noreferrer">Jiray</a> | Admin - <a href="https://zalo.me/0978200223" target="_blank" rel="noopener noreferrer author">Jiray Software</a>
      </p>
      <p>
</span>
</body>
